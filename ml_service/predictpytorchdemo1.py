...
preprocessor_reverse = joblib.load("preprocessing_pipeline_reverse_1.joblib")  # For /reverse
...
model_reverse.load_state_dict(torch.load("best_mlp_model_2output.pt", map_location=device))
